...
class SCFT {
public:
    SCFT(int M_x, int N_s, double L, double N, double R_g, double f, double chiN, double mixing_parameter);
    void Run();
    ...
    double Determine_Average();
private:
    qPropagator q_propagator;
    qDaggerPropagator q_star_propagator;
    int M_x,N_s;
    double L,  N,  R_g,  f,  chiN, mixing_parameter;
